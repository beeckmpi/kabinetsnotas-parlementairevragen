...
<html lang="en" class="no-js">
	...
	<body>	
	  ...
	  <header id="top">
	      ...
	      <div id="page-title">Parlementaire Vragen en KabinetsNota's</div>
	      <ul id="top-options">
		...
		<section id="dossiers" class="grid grid-2">
			<section id="lay_over" class="grid grid-2 lay-over">
		 	 	<div style="margin: 5px 10px; min-width: 950px; min-height: 355px;">test</div>
			</section>		
		   	<div id="user_settings_form" >
			   <div id="message"><?php if (isset($message)): echo $message; endif;?></div>
